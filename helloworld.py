...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(170, 70, 61, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.plainTextEdit = QtGui.QPlainTextEdit(Form)
        self.plainTextEdit.setGeometry(QtCore.QRect(90, 170, 104, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "HelloWorld", None))
